...
#  echo export "${aws_ssm_pm_2}"=$(aws ssm get-parameter --name "${aws_ssm_pm_1}" --region us-east-1 --with-decryption --query "Parameter.Value" --output text) >>/parameters-storage/parameters
#done
#
